<!--
This is a Svelte component from svelte-loadable:

GitHub Repository: [kaisermann/svelte-loadable](https://github.com/kaisermann/svelte-loadable)

All components in this directory are sourced from the svelte-loadable project by kaisermann. Please refer to the original repository for documentation, examples, and additional components.
-->
