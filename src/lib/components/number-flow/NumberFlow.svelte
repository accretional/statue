...
Demo Site: [number-flow.barvian.me](https://number-flow.barvian.me/svelte)
GitHub Repository: [barvian/number-flow](https://github.com/barvian/number-flow)

All components in this directory are sourced from the NumberFlow project. Please refer to the original repository for documentation, examples, and additional components.
-->
...
<script lang="ts">
	...
	type GroupContext = { register: (el: any) => void }
	...
	// Handle grouping. Keep as much logic in NumberFlowGroup as possible
	// for better tree-shaking:
	const group = getContext<GroupContext | undefined>(groupKey)
