...
<script lang="ts" generics="T">
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // WINDOW RESIZER  (from core/resizer.ts — createWindowResizer)
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  const createWindowResizer = (store: VirtualStore, isHorizontal: boolean) => {
    ...
    return {
      $observeRoot(container: HTMLElement) {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // WINDOW SCROLLER  (from core/scroller.ts — createWindowScroller)
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  const createWindowScroller = (store: VirtualStore, isHorizontal: boolean) => {
    ...
    const [scheduleScroll] = createScrollScheduler(
      ...
      (offset, smooth) => {
        ...
        if (smooth) {
          window.scroll({ [scrollToKey]: offset, behavior: "smooth" });
        } else {
    ...
    const calcOffsetToViewport = (
      ...
      if (node === viewport || !parent) return offsetSum;
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // COMPONENT TYPES  (from WindowVirtualizer.type.ts)
  // ═══════════════════════════════════════════════════════════════════════════
