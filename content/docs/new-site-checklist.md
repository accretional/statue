...
**Why:** Template variables like `Accretional` will show your info throughout the site.

[Full config guide →](/docs/site-config)
...
- **[Getting Started](/docs/get-started)** - Overview of Statue basics
- **[Site Config](/docs/site-config)** - Configuration details
- **[Themes](/docs/themes)** - Styling guide
- **[Components](/docs/components)** - Component reference
